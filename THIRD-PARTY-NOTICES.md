...
| apple-cf | 0.9.3 | MIT OR Apache-2.0 |
| apple-metal | 0.8.8 | MIT OR Apache-2.0 |
...
| doom-fish-utils | 0.3.3 | MIT OR Apache-2.0 |
...
| libredox | 0.1.17 | MIT |
| libspa | 0.9.2 | MIT |
| libspa-sys | 0.9.2 | MIT |
| libwayshot-xcap | 0.3.2 | BSD-2-Clause |
...
| screencapturekit | 8.0.0 | MIT OR Apache-2.0 |
